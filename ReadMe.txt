LICENCES:
LICENCE_GNU_V3 applies to all files in the repository with the exception of the randomized data contained in dataRANDOMIZED.csv and data2016RANDOMIZED.csv, which are covered by LICENCE_CC0. 
...
The files dataPlots and publication plots reproduce the figures.
